...
import academy.jairo.quarkus.rabbitmq.consumer.client.Client;
import academy.jairo.quarkus.rabbitmq.consumer.client.ClientMapper;
import academy.jairo.quarkus.rabbitmq.consumer.client.ClientRequestBody;
...
public class ConsumerProcessor {
    ...
    public void process(String request) throws InterruptedException {
        log.infof("Receiving from rabbitmq string-channel > %s", request);
        Thread.sleep(200);
    }
    ...
    public void processClientBody(JsonObject requestBody) throws InterruptedException {
        log.infof("Receiving from rabbitmq json-channel > %s", requestBody);
        Thread.sleep(200);
