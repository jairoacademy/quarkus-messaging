...
class ConsumerProcessorStringChannelTest {
    ...
    public static void switchMyChannels() {
        InMemoryConnector.switchIncomingChannelsToInMemory("string-channel");
    ...
    void process() {
        ...
        InMemorySource<String> inChanel = connector.source("string-channel");

        InMemorySink<Integer> results = connector.sink("out-channel");
