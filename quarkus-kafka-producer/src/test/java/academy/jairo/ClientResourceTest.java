...
class ClientResourceTest {
    ...
    public static void switchMyChannels() {
        InMemoryConnector.switchOutgoingChannelsToInMemory("string-topic");
        InMemoryConnector.switchOutgoingChannelsToInMemory("json-topic");
    }
    ...
    void testCreateMessagingEndpoint() {
        ...
        InMemorySink<String> queue = connector.sink("string-topic");
    ...
    void testCreateClientBodyEndpoint() {
        ...
        InMemorySink<String> queue = connector.sink("json-topic");
